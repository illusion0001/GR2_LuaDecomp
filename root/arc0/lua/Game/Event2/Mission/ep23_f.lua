...
function Initialize()
  ...
  _pdemo = PDemo.create("ep23_e_c01", nil, {camera = false, scene_param = false})
end
function Ingame()
  ...
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 37.5
  Sound:playSE("xey_001", 1, "", L5_5)
  Fn_captionView("ep23_05001", 10)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 240
  Sound:playSE("syd_183", 1, "", L6_6)
  Fn_captionView("ep23_05002", 10)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 410
  Fn_captionView("ep23_05003", 10)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 520
  Sound:playSE("xey_002", 1, "", L5_5)
  Fn_captionView("ep23_05004", 6)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 680
