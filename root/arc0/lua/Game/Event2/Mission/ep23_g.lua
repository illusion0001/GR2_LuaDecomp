...
function Initialize()
  ...
  _pdemo = PDemo.create("ep23_f_c01", nil, {camera = false, scene_param = false})
end
function Ingame()
  ...
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 60
  Sound:playSE("ala_028", 1, "", L5_5)
  Fn_captionView("ep23_06001", 10)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 225
  Fn_captionView("ep23_06002", 10)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 525
  Fn_captionView("ep23_06003", 10)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 705
  Sound:playSE("ala_029", 1, "", L5_5)
  Fn_captionView("ep23_06004", 6)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 990
...
function Finalize()
  if _vctrl_task ~= nil and _vctrl_task:isRunning() then
    _vctrl_task:abort()
  end
  _vctrl_task = nil
end
