...
function Initialize()
  ...
  _pdemo = PDemo.create("ep23_b_c01", nil, {camera = false, scene_param = false})
end
function Ingame()
  ...
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 150
  Fn_captionView("ep23_02001", 10)
  Sound:playSE("m43_001", 1, "", L5_5)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 270
  Fn_captionView("ep23_02002", 10)
  Sound:playSE("m44_001", 1, "", L5_5)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 355
  Fn_captionView("ep23_02003", 10)
  Sound:playSE("ala_022", 1, "", L5_5)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 445
  Fn_captionView("ep23_02004", 10)
  Sound:playSE("m29_003", 1, "", L5_5)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 565
  Fn_captionView("ep23_02005", 10)
  Sound:playSE("ala_023", 1, "", L5_5)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 660
  Fn_captionView("ep23_02006", 6)
  Sound:playSE("m43_002", 1, "", L5_5)
  Sound:playSE("m44_002", 1, "", L5_5)
  Sound:playSE("m29_004", 1, "", L5_5)
  repeat
    wait()
  until _pdemo:getCurrentFrame() >= 840
