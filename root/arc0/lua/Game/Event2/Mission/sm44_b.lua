...
function Initialize()
  ...
  _puppets.father_01:loadPoseAnimation("walk", "auj01_walk_00")
  Fn_loadNpcEventMotion("father_01", NPC_MOTION)
  sm44_InitGame(2, "father_01", FATHER_WALK_RATE, FATHER_FEINT_RANGE, FATHER_FEINT_NUM, "locator2_pc_start_pos", FATHER_FRONT_RANGE, FATHER_FRONT_OUTRANGE, FATHER_FRONT_ANGLE, FATHER_FRONT_DANGER, FATHER_NEAR_RANGE, FATHER_AROUND_RANGE, OTHER_CREATE_NUM)
  _father_sdemo = SDemo.create("sm44_father_sdemo")
end
function Ingame()
  Fn_userCtrlAllOff()
  Fn_findNpc("father_01"):ignoreStoop()
  Fn_sendEventComSb("sm44_startCatWarp", "sm44_b", _puppets.father_01)
  ...
  Fn_captionViewWait("sm44_01000")
  Fn_captionViewWait("sm44_01001")
  Fn_captionViewWait("sm44_01002")
  ...
  while true do
    ...
    sm44_StopGame()
    if not FatherArrivalCheck(2, "father_01", NPC_MOTION.talk04, #FATHER_FEINT_NUM) then
    end
  end
  Fn_blackout()
