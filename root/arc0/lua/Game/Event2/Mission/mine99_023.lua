...
_event_file_name = "floor_023"
_floor_num = 23
_litho_theme = nil
_enemy_count = 0
_damage_check_task = nil
_litho_wait_task = nil
enmgen2_a_17_mine99_023 = {
  spawnOnStart = false,
  autoPrepare = true,
  ...
  spawnSet = {
    {
      type = "giant_mine_12",
      locator = "locator_mine99_023_01",
      name = "giant01"
    },
    {
      type = "stalker_mine_02",
      locator = "locator_mine99_023_02",
      name = "stalker01"
    },
    {
      type = "lasercannon_mine_02",
      locator = "locator_mine99_023_03",
      name = "lasercannon01"
    },
    {
      type = "gellyfish_mine_02",
      locator = "locator_mine99_023_04",
      name = "gellyfish01"
    },
    {
      type = "gellyfish_mine_02",
      locator = "locator_mine99_023_05",
      name = "gellyfish02"
    },
    {
      type = "jammer_mine_02",
      locator = "locator_mine99_023_06",
      name = "jammer01"
    },
    {
      type = "stalker_mine_12",
      locator = "locator_mine99_023_07",
      name = "stalker02"
    },
    {
      type = "stalker_mine_12",
      locator = "locator_mine99_023_08",
      name = "stalker03"
    },
    {
      type = "defender_mine_02",
      locator = "locator_mine99_023_10",
      name = "defender02"
    },
    {
      type = "imp_mine_12",
      locator = "locator_mine99_023_11",
      name = "imp01"
    }
  },
  deadEnemies = 0,
...
enmgen2_a_22_01 = {
  ...
  spawnSet = {
    {
      type = "guardcore_mine_12",
      locator = "locator_a_22_01",
      name = "guardcore01"
    },
    {
      type = "guardcore_mine_12",
      locator = "locator_a_22_02",
      name = "guardcore02"
    },
    {
      type = "guardcore_mine_12",
      locator = "locator_a_22_03",
      name = "guardcore03"
    },
    {
      type = "jammer_mine_02",
      locator = "locator_a_22_04",
      name = "jammer01"
    },
    {
      type = "imp_mine_12",
      locator = "locator_a_22_05",
      name = "imp01"
    },
    {
      type = "imp_mine_12",
      locator = "locator_a_22_06",
      name = "imp02"
    }
  },
  deadEnemies = 0,
...
function IngameBody()
  ...
  if _create_fire_effect == false then
    ...
    putCandleFireEffect("az2_a_22", _candle_fire_max_az2_a_22, true)
  ...
  if Fn_getMine99FloorClear() then
    ...
    Fn_missionView("ic_pi_monument_obj_00230", 0, nil, true)
    ...
    waitSeconds(2)
    if findGameObject2("EnemyGenerator", "enmgen2_a_17_mine99_023") ~= nil then
      findGameObject2("EnemyGenerator", "enmgen2_a_17_mine99_023"):requestSpawn()
      _enemy_count = #findGameObject2("EnemyGenerator", "enmgen2_a_17_mine99_023"):getSpecTable().spawnSet
    end
    findGameObject2("EnemyGenerator", "enmgen2_a_17_mine99_023"):setEventListener("DestroyEnemyReport", Fn_destroyEnemyReport)
    HUD:counter999SetTextID("ic_pi_mine99_002")
    HUD:counter999SetIcon(HUD.kCount99_99IconType_Stone)
    HUD:counter999SetNum(_enemy_count)
    HUD:counter999SetVisible(true)
    _damage_check_task = invokeTask(function()
      local L0_56
      L0_56 = Player
      L0_56 = L0_56.getEnergy
      L0_56 = L0_56(L0_56, Player.kEnergy_Life)
      while _litho_theme == nil do
        L0_56 = Player:getEnergy(Player.kEnergy_Life)
        print("Player:getEnergy" .. Player:getEnergy(Player.kEnergy_Life))
        if L0_56 > L0_56 then
          _litho_theme = false
        end
        wait()
...
function Fn_destroyEnemyReport(A0_57)
...
function lithoThemeInit()
  _litho_theme = nil
  _enemyCount = 0
  if _damage_check_task ~= nil then
    _damage_check_task:abort()
    _damage_check_task = nil
  end
...
function requestEnemyKill(A0_58, A1_59)
  local L2_60
  L2_60 = Fn_findAreaHandle
  L2_60 = L2_60(A0_58)
  if L2_60 ~= nil then
    L2_60 = "enmgen2_"
    L2_60 = L2_60 .. A1_59
    if findGameObject2("EnemyGenerator", L2_60) then
      print(string.format("EnemyGenerator:%s \227\129\174\230\149\181\227\130\146\229\137\138\233\153\164\227\129\151\227\129\190\227\129\153\227\128\130", L2_60))
      findGameObject2("EnemyGenerator", L2_60):requestAllEnemyKill()
    else
      print(string.format("EnemyGenerator:%s \227\129\175\232\166\139\227\129\164\227\129\139\227\130\138\227\129\190\227\130\147\227\129\167\227\129\151\227\129\159\227\128\130", L2_60))
    end
  else
    L2_60 = print
    L2_60(string.format("%s \227\130\168\227\131\170\227\130\162\227\129\175\232\166\139\227\129\164\227\129\139\227\130\138\227\129\190\227\130\147\227\129\167\227\129\151\227\129\159\227\128\130", A0_58))
  end
end
