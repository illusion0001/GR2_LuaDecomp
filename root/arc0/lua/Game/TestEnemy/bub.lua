...
function main()
  Sound:loadResource("enemy_se_hex")
  Sound:loadResource("enemy_se_jir")
  ...
  enmgen = findGameObject2("EnemyGenerator", "enmgen2_01")
  enmgen:requestSpawn()
  while enmgen:isPrepared() == false do
    wait()
  end
  while findGameObject2("Puppet", "ene_bub"):getBrain():isReadyEnemy() == false do
    wait()
  end
  findGameObject2("Puppet", "ene_bub"):getBrain():cmd("release", "locator_soldier")
end
